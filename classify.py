...
original_data = pd.read_csv("dataset/steam_review.csv")
...
data_frame, test_data = train_test_split(data_frame, test_size = 0.40)
train_data, dev_data = train_test_split(data_frame, test_size = 0.40)

# Transforming the each reviews into vectors using TF-IDF
...
r2_score = svmmnb(['One of the best game I iever play.'])
print('Review 2: One of the best game I iever play.')
